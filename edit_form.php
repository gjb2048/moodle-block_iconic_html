 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_iconic_html_edit_form extends block_edit_form {
    ...
    function set_data($defaults) {
        if (!empty($this->block->config) && is_object($this->block->config)) {
            ...
            $defaults->config_text['text'] = file_prepare_draft_area($draftid_editor, $this->block->context->id, 'block_iconic_html', 'content', 0, array('subdirs'=>true), $currenttext);
